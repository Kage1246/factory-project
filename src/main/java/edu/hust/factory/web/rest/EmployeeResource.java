...
/**
 * REST controller for managing {@link edu.hust.factory.domain.Employee}.
 */
@RestController
...
public class EmployeeResource {
    ...
    /**
     * {@code POST  /employees/search} : Search employee.
     *
     * @param input
     * @return
     */
    @PostMapping("/search")
    public PageResponse<List<EmployeeDTO>> search(@RequestBody PageFilterInput<EmployeeDTO> input) {
     ...
     */
    @PostMapping("")
    public ResponseEntity<EmployeeDTO> createEmployee(@RequestBody EmployeeDTO employeeDTO) throws URISyntaxException, CustomException {
